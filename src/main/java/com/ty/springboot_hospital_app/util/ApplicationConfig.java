...
public class ApplicationConfig {
	...
	public Docket getDocket() {
		...
		Contact contact=new Contact("TYSS", "www.tyss.com", "tyss@mail.com");
		
		List<VendorExtension> extensions=new ArrayList<>();
		
		ApiInfo apiInfo=new ApiInfo("Hospital App", "hospital Api v1.0", "version 1.0", "www.tyssglobal.com", contact, "tyss12345", "www.testyantra.com", extensions);
